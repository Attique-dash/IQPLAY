        ...
        <div className="h-[5.5rem] text-white bg-gray-800 flex items-center justify-between px-4 relative">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex space-x-4">
              <button
                onClick={EndGame}
                className="bg-gray-600 sm:w-32 md:w-36 h-10 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded"
              >
                End of Game
              </button>
              <button
                onClick={ExitGame}
                className="bg-red-600 h-10 w-20 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded"
              >
                Exit
              </button>
            </div>
          ...
          <div
            className={`fixed top-0 left-0 h-full w-60 bg-gray-900 shadow-lg flex flex-col items-center transition-transform duration-300 ${
            ...
            <div className="p-4">
              <div className="flex mb-5">
                <Image
                  ...
                  className="mt-0"
                />
                <p className="sm:text-2xl text-2xl font-semibold ml-5">
                  IQPLAY
                </p>
                <div
                  onClick={() => setSidebarOpen(!isSidebarOpen)}
                  className="flex text-4xl ml-5 font-semibold"
                >
                  {isSidebarOpen ? <RxCross2 /> : null}
                </div>
              </div>
              ...
              <button
                onClick={EndGame}
                className="w-[85%] rounded-lg mt-3 py-3 text-white bg-gray-700 "
              >
                End Game
              </button>
              <button
                onClick={ExitGame}
                className="w-[85%] mt-3 py-3 rounded-lg text-white bg-red-700"
              >
                Exit
              </button>
            </div>
